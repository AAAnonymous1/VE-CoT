...
async def image_detection(image_path:str, txt_prompt:str):
    ...
    """
    try:
        annotated_image_path = get_new_path(image_path, "annotated")
        annotated_txt_path = get_new_path(image_path, "boxes", ".txt")
        GDINO_CONFIG.image = image_path
        GDINO_CONFIG.additional_prompt = txt_prompt
        GDINO_CONFIG.output_image = annotated_image_path
        GDINO_CONFIG.output_txt = annotated_txt_path
        gdino_run(GDINO_CONFIG)
